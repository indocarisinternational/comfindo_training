export const services = [
  {
    ...
    benefits: [
      ...
      "Sesuai dengan standar SKKNI (Standar Kompetensi Kerja Nasional Indonesia).",
      "Memperkuat portofolio dan CV Anda.",
    ],
    process: [
      "Pendaftaran dan verifikasi berkas.",
      "Pelatihan berbasis kompetensi.",
      "Uji Kompetensi oleh Asesor LSP.",
      "Penerbitan sertifikat BNSP.",
    ],
    faq: [
      { q: "Berapa lama sertifikat BNSP berlaku?", a: "Sertifikat BNSP berlaku selama 3 tahun dan dapat diperpanjang melalui proses re-asesmen." },
      { q: "Apakah sertifikat BNSP diakui di luar negeri?", a: "Sertifikat BNSP adalah sertifikasi nasional. Untuk pengakuan internasional, diperlukan sertifikasi tambahan." },
    ],
  },
  {
    ...
    benefits: [
      ...
      "Pilihan program pelatihan yang beragam.",
      "Didukung oleh silabus berbasis SKKNI.",
    ],
    process: [
      "Pilih program pelatihan yang diminati.",
      "Lakukan pembayaran dan konfirmasi.",
      "Ikuti pelatihan online/offline.",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Efisiensi biaya pelatihan untuk tim.",
      "Sertifikat untuk seluruh peserta.",
    ],
    process: [
      "Konsultasi kebutuhan pelatihan.",
      "Penyusunan proposal dan materi khusus.",
      "Pelaksanaan pelatihan di lokasi atau online.",
      "Evaluasi dan penerbitan sertifikat.",
    ],
    faq: [
      { q: "Berapa minimal peserta untuk In House Training?", a: "Minimal 10 peserta untuk program In House Training." },
      { q: "Apakah bisa custom materi?", a: "Ya, materi pelatihan dapat disesuaikan sepenuhnya dengan kebutuhan perusahaan Anda." },
    ],
  },
  {
    slug: "cek-sertifikat",
    ...
    benefits: [
      ...
      "Database sertifikat terintegrasi.",
      "Tersedia 24/7 melalui website.",
    ],
    process: [
      "Masukkan nomor sertifikat atau nama peserta.",
      "Sistem akan mencari data di database.",
      "Hasil verifikasi ditampilkan secara real-time.",
      "Download ulang sertifikat jika diperlukan.",
    ],
    faq: [
      { q: "Bagaimana jika sertifikat tidak ditemukan?", a: "Hubungi kami melalui WhatsApp di 0858-7066-3856 untuk bantuan lebih lanjut." },
    ],
  },
]
