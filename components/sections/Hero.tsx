        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col text-white max-w-xl">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/10">
                ...
                <span className="text-sm font-medium text-white/90">{day} {month}</span>
              </div>
          ...
          <div className="hidden lg:grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={feature.title}
                className={`group bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1 ${i % 2 === 1 ? "mt-6" : ""
                  }`}
              >
