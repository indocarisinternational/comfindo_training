...
export default function TrainingPage() {
  ...
  useEffect(() => {
    ...
    supabase.from("training_programs").select("*").eq("is_published", true).order("created_at", { ascending: false })
  ...
  }, [selectedCategory, selectedMonth, searchQuery, trainings])
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 md:py-16">
        <div className="container max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 xl:px-20">
          ...
          {loading ? (
            <div className="text-center py-20 text-gray-400">Memuat program...</div>
          ) : (
